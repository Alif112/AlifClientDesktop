...
public class IPv4withGPRSImplementation {
    ...
    public static short bvci=50,delayValue;
...
//        qos profile
        ...
        //--------------------- IMSI---------------------------------
//        data[index++]=0x0d;
//        data[index++]=(byte) 0x88; //len
//        data[index++]=0x49; data[index++]=0x06; //china code 460
//        data[index++]=0x00; //can be random
//        data[index++]=(byte) 0x83; data[index++]=0x01;
//        data[index++]=0x33; data[index++]=0x70; data[index++]=0x70;
